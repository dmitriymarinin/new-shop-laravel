                ...
                <div class="avds_large_container">
                    <div class="avds_large_content">
                        ...
                        <div class="avds_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a
                            ultricies
                            metus. Sed nec molestie eros. Sed viver ra velit venenatis fermentum luctus.
                        </div>
                ...
                <div class="col">
                    ...
                    <div class="product_grid">
                        ...
                        @foreach($products as $product)
                            <!-- Product -->
                            @php
                                $image = count($product->images) > 0 ? $image = $product->images[0]['img'] : 'product_1.jpg';
                            @endphp
                            <div class="product">
                ...
                <div class="col-lg-8 offset-lg-2">
                    <div class="newsletter_content text-center">
                        ...
                        <div class="newsletter_text"><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam
                                a
                                ultricies metus. Sed nec molestie eros</p></div>
